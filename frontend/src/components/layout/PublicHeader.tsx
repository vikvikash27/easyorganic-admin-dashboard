...
import { Logo, ChevronDownIcon, UserIcon, LogoutIcon } from "../icons";
...
const PublicHeader: React.FC = () => {
  ...
  const productsMenuTimeoutRef = useRef<
  ...
  return (
    <>
      <header
        className="bg-white/90 backdrop-blur-md sticky top-0 z-30 shadow-sm border-b border-slate-200"
        ...
        <div className="container mx-auto px-6 py-3">
          <div className="flex justify-between items-center">
            ...
            >
              <div className="py-2">
                <NavLink
                  to="/products"
                  className={({ isActive }) =>
                    `text-slate-600 hover:text-brand-primary font-medium flex items-center gap-1 ${
                      (isActive || isProductsMenuOpen) && "text-brand-primary"
                    }`
                  }
                >
                  Products
              ...
              <a
                href="#"
                className="text-slate-600 hover:text-brand-primary font-medium"
              >
                Reviews
              </a>
              <a
            ...
            <div className="flex items-center gap-4">
              ...
              <NavLink
                to="/cart"
                className="relative text-slate-600 hover:text-brand-primary p-2"
              >
                <ShoppingCartIcon />
                {cartCount > 0 && (
