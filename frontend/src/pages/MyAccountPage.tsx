      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2">
          <Card className="space-y-4">
            <h3 className="text-lg font-semibold text-slate-700 border-b pb-3">
              Account Dashboard
            </h3>
            <Link
              to="/account/orders"
              className="flex justify-between items-center p-4 rounded-lg hover:bg-slate-100 transition-colors"
            >
              <div>
